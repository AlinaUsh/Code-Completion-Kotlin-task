...
from .lexer import (
    ...
    StringLiteral,
    UnsignedLiteral,
    DocstringToken, DelimitedComment
)
...
class Parser:
    ...
    def parse_declaration(self,
        ...
        declaration:
            ...
            | propertyDeclaration | typeAlias | Docstring
        """
        mapping: dict[type, ParseFunc] = {
            ...
            node.Docstring: self.parse_docstring,
        }
    ...
    def parse_class_member_declaration(self) -> node.ClassMemberDeclaration:
        ...
        with self.tokens.simulate():
            ...
            elif token.startswith(("class", "interface", "fun", "object", "val", "var",
                           "typealias", "/**")):
    ...
    def parse_docstring(self) -> node.Docstring:
        """
        Doctring:
            docstringToken
            declaration
        """
        token = self._accept(DocstringToken)
        docstring: str = token.value
        self._consume_new_lines()
        declaration = Optional[node.Declaration]
        try:
            declaration = self.parse_declaration()
        except:
            raise "No declaration found"
    ...
    def _get_declaration_type(self) -> Optional[Type[node.Declaration]]:
        ...
        with self.tokens.simulate():
            ...
            if self._would_accept_either("class", "interface",
                ...
                ret = node.TypeAlias
            elif self._would_accept(DocstringToken):
                ret = node.Docstring
        return ret
